...
function findTriangleWithEdge(triangles: Uint32Array | Int32Array | Uint16Array | Int16Array | ArrayLike<number>, edge: Edge): number {
	const [e0, e1] = edge;
...
export function triangulate(contour: Coordinate[], holes: Coordinate[][], extraPoints: Coordinate[] = []): TriangulationResult {
	let offset = 0;
