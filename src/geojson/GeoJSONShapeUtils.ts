...
export function traverse(object: ParsedGeoJSONObject, callback: (object: ParsedGeoJSONObject) => void): void {
	callback(object);
...
export function resampleLine(loop: Coordinate[], minDistance: number, mode: ResampleMode = 'grid'): Coordinate[] {
