...
export interface ParsedPoint extends ParsedGeoJSONObjectBase<'Point', LineStringCoords>, HasFeatureRef {
	dimension: number | null;
}

export interface ParsedMultiPoint extends ParsedGeoJSONObjectBase<'MultiPoint', LineStringCoords>, HasFeatureRef {
	dimension: number | null;
}

export interface ParsedLineString extends ParsedGeoJSONObjectBase<'LineString', LineStringCoords[]>, HasFeatureRef {
	dimension: number | null;
	getLineObject: (options?: LineObjectOptions) => LineSegments;
}

export interface ParsedMultiLineString extends ParsedGeoJSONObjectBase<'MultiLineString', LineStringCoords[]>, HasFeatureRef {
	dimension: number | null;
	getLineObject: (options?: LineObjectOptions) => LineSegments;
}

export interface ParsedPolygon extends ParsedGeoJSONObjectBase<'Polygon', PolygonCoords[]>, HasFeatureRef {
	dimension: number | null;
	getLineObject: (options?: LineObjectOptions) => LineSegments;
	getMeshObject: (options?: PolygonMeshOptions) => Mesh;
}

export interface ParsedMultiPolygon extends ParsedGeoJSONObjectBase<'MultiPolygon', PolygonCoords[]>, HasFeatureRef {
	dimension: number | null;
	getLineObject: (options?: LineObjectOptions) => LineSegments;
	getMeshObject: (options?: PolygonMeshOptions) => Mesh;
}

export interface ParsedGeometryCollection extends ParsedGeoJSONObjectBase<'GeometryCollection', ParsedGeometry[]>, HasFeatureRef {}
...
export interface ParsedFeatureCollection extends ParsedGeoJSONObjectBase<'FeatureCollection', ParsedFeature[]> {}

export type ParsedGeoJSONObject = ParsedGeometry | ParsedFeature | ParsedFeatureCollection | ParsedGeometryCollection;
